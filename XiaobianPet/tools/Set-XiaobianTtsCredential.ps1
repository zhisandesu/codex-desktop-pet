...
$credentialTarget = 'XiaobianPet/ArkAgentPlanTts'
...
Write-Host 'Configure XiaobianPet Ark Agent Plan TTS'
Write-Host "Credential Manager target: $credentialTarget"
$apiKey = Read-Host 'Enter the Ark Agent Plan API Key (input is hidden)' -AsSecureString
...
try {
    ...
    Write-Host 'Saved. XiaobianPet will use this credential for the next announcement.' -ForegroundColor Green
}
finally {
